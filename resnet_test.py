...
from networks import get_cnn, get_df_cnn, get_mini_resnet
...
cnn_path = './models/resnet.h5'
plot_path = './figures/resnet_train_acc_val.png'
...
inputs, outputs = get_mini_resnet()
